<div class="row clearfix">
		<div class="col-md-12 column">
            ...
            <fieldset><legend>iRain - Register</legend>
				...
				<div class="form-group">
					 <label for="exampleInputPassword1">Password</label><input type="password" class="form-control" id="respassword" />
				</div>
                <!--
				<div class="form-group">
					 <label for="exampleInputPassword1">First name</label><input type="text" class="form-control" id="firstname" />
				</div>
                <div class="form-group">
