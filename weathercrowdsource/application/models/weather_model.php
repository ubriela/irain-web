...
class Weather_model extends CI_Model{
    ...
    public function spatiotemporal_query($SW_lat, $SW_lng, $NE_lat, $NE_lng, $from = '1979-01-01 00:00:00', $to = '2015-01-01 00:00:00') {
        ...
        if($start>$end){
            ...
            $query = $this->db->select('x(worker_location) AS lat, y(worker_location) AS lng,response_code,level, response_date')->distinct('worker_location')->from('responses,tasks')->where($condition)->order_by('responses.response_date','desc')->get();
