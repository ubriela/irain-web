...
class Geocrowd extends CI_Controller {
    ...
    function spatiotemporal_query($SW_lat, $SW_lng, $NE_lat, $NE_lng, $from = '1979-01-01 00:00:00', $to = '2015-01-01 00:00:00') {
        ...
        $query = $this->db->select('id, x(location) AS lat, y(location) AS lng, response_code, response_date')->from('weather_location')->where($condition)->order_by('response_date')->get();
